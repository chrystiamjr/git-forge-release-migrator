...
String checkpointSignature(RuntimeOptions options, ProviderRef sourceRef, ProviderRef targetRef) {
  return <String>[
...
String buildRetryCommand(RuntimeOptions options, File failedTagsFile) {
...
Future<void> writeSummary({
  ...
  final List<String> sortedFailed = failedTags.toList(growable: true)..sort(semverCompare);
  ...
  final Map<String, dynamic> payload = <String, dynamic>{
    ...
    'order': '${capitalizeProvider(options.sourceProvider)} -> ${capitalizeProvider(options.targetProvider)}',
